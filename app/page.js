  ...
  return (
    <>
      ...
      <div className="bg-white">
        <div className="mx-auto max-w-2xl px-4 py-16 sm:px-6 sm:py-24 lg:max-w-7xl lg:px-8 ml-10">
        ...
        {Services.map((service) => (
            <Link key={service.id} href={`/services/${service.id - 1}`}>
                <CardDefault service={service} className="h-full w-full p-4 rounded-lg border shadow-sm mr-[40%] " />
            </Link>
  ))}
</div>
